...
from App.Services.SupabaseService import (
    supabase_service,
...
async def get_prediction_from_name(
    city: str, days: int, authenticated: bool = Depends(verify_token)
):
...
async def get_prediction_from_coordinate(
    latitude: float,
    longitude: float,
    days: int,
